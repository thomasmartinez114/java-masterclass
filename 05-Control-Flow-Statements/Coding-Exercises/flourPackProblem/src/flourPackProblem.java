public class flourPackProblem {
    ...
    public static boolean canPack (int bigCount, int smallCount, int goal) {
        ...
        bigCount *= 5; // multiple by 5 to get full number of kilos

        System.out.println("Total kilos of bigCount bags: " + bigCount +
                ". \nTotal kilos of smallCount bags: " + smallCount +
                ". \nKilo goal amount is: " + goal);
...
//        least equal to the value of goal. The method should return true if it is possible to
//        make a package with goal kilos of flour.
//
//        If the sum is greater than goal, ensure that only full bags are used
//        towards the goal amount. For example, if goal = 9, bigCount = 2, and smallCount = 0,
...
//        true because of 1 full bigCount bag and 4 full smallCount bags equal goal, and it's
...
//
//
//        NOTE: The method canPack should be defined as public static like
